      ...
      compairList.forEach(compairItem => {
        ...
        compairListDOM.insertAdjacentHTML('beforeend', `
              <div class="compair__item">
                <img class="compair__item__image" src="${compairItem.image}" alt="${compairItem.name}" />
                <h3 class="compair__item__name">${compairItem.name}</h3>
                <h3 class="compair__item__price">${compairItem.price}</h3>
          ...
          addToCompairButtonsDOM.forEach(addToCompairButtonDOM => {
            ...
            if(productDOM.querySelector('.product__name').innerText === compairOBJ.name){
