(function (){
    ...
    let clearButton = document.querySelector('[data-action="CLEAR_ALL"]');
    ...
    function productCount(){
      ...
      listCount.innerText = 'Selected Items: ' + compairList.length;
    }
    ...
    clearButton.addEventListener('click', () => clearAll(addToCompairButtonsDOM));
    ...
    function clearAll(addToCompairButtonDOM){
      if (confirm("Are you sure want to clear selected list")) {
        compairList = [];
        localStorage.setItem('compairList', JSON.stringify(compairList));
        console.log(addToCompairButtonDOM.disabled);
        compairListSection.innerHTML = '';
      } else {
